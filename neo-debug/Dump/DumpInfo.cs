...
using Neo.VM;
using Neo.VM.Types;
using static Neo.VM.EvaluationStack;

namespace Neo.SmartContract.Dump
{
    ...
    public class LogOp
    {
        ...
        public VM.EvaluationStack.Op[] stack;
    ...
    public class DumpInfo
    {
        ...
        public void OPStackRecord(VM.EvaluationStack.Op[] records)
        {
            curOp.stack = records;
        }
